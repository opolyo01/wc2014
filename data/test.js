/*
Group {A:[teamA, teamB, teamC, teamD], B: {}}
Game {teamA, teamB, date, groupId, teamAScore, teamBScore, completed}
User
Score - {teamA, teamB, userId, gameId}
Points = get All scores for userId and compare with Game score
...
(11) Sun Jun/15 19:00   Argentina - Bosnia-Herzegovina    @ Estádio do Maracanã, Rio de Janeiro (UTC-3)
...
(28) Sat Jun/21 18:00   Nigeria - Bosnia-Herzegovina      @ Arena Pantanal, Cuiabá (UTC-4)

(43) Wed Jun/25 13:00   Nigeria - Argentina               @ Porto Alegre (UTC-3)
(44) Wed Jun/25 13:00   Bosnia-Herzegovina - Iran         @ Salvador (UTC-3)
